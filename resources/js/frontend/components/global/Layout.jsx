...
export function MainLayout(props) {
    ...
    //         ).toUpperCase();
    //         // setUserDetails({ ...userDetails, ['initials']: initials })
    //         setUserDetails({
    //             name: user?.name,
    //             initials: initials,
    //         })
                ...
                items={[
                    ...
                    },
                    {
                        ...
                        subNavigationItems: [
                            ...
                            {
                                url: "/shop-page-setting",
                                label: "Shop Page Setting",
                                onClick: () =>
                                    setLocationChange("/shop-page-setting"),
                            },
                        ],
                    },
                    {
                        ...
                        subNavigationItems: [
                            {
                                ...
                                onClick: () =>
                                    setLocationChange("/productslisting"),
                            },

                            {
                                ...
                                onClick: () =>
                                    setLocationChange("/import-product"),
                            },
                        ],
                    },
                    {
                        ...
                        subNavigationItems: [
                            {
                                ...
                                label: "Order Listing",
                                onClick: () =>
                                    setLocationChange("/orderslisting"),
                            },
                        ],
                    },
                    {
                        ...
                        subNavigationItems: [
                            {
                                ...
                                onClick: () =>
                                    setLocationChange("/commissionslisting"),
                            },
                            {
                                url: "/global-commission-setting",
                                label: "Global Commission Setting",
                                onClick: () =>
                                    setLocationChange(
                            ...
                            {
                                url: "/seller-commission-setting",
                                label: "Seller Commission Setting",
                                onClick: () =>
                                    setLocationChange(
                                        "/seller-commission-setting"
                                    ),
                            },
                        ],
                    },
    ...
    const logo = {
        width: 124,
        topBarSource: checkifyLogo,
        contextualSaveBarSource: checkifyLogo,
        url: "/",
        ...
        <div style={{ height: "500px" }}>
            {location.pathname == "/not-found" ? (
                ...
                <Frame
                    logo={logo}
                    topBar={topBarMarkup}
                    navigation={NavigationMarkupPrimary}
